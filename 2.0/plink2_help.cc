...
"  --ld-score-window-cm <max centimorgan radius>\n"
"    Compute each variant's LD Score: the sum of unbiased r^2 with every other\n"
"    variant in a window around it, plus 1 for itself.  This is the statistic\n"
"    LD Score regression takes as input.\n"
"    * The unbiased estimator is r^2 - (1 - r^2)/(n - 2), with n the number of\n"
"      samples the pair has in common.  The correction is what makes a pair of\n"
"      unlinked variants contribute zero on average instead of 1/n.\n"
"    * Only founders are considered, as with --r2-unphased.  When nonfounders\n"
"      are present you must say which you want: --ld-score-founders to confirm\n"
"      the founders-only default, or --nonfounders to include everyone.\n"
"    * The default window is a 1 centimorgan radius, so nonzero CM coordinates\n"
"      are required unless --ld-score-window or --ld-score-window-kb is given.\n"
...
"      Default is chrom,ref,alt,maybeprovref,omitted.\n"
    ...
    HelpPrint("clump-p1\0clump-p2\0clump-r2\0clump-kb\0clump-unphased\0clump-index-first\0clump-replicate\0clump-verbose\0clump-best\0clump-annotate\0clump-log10\0clump-range\0clump-range0\0clump-range-border\0clump-bins\0clump-id-field\0clump-p-field\0clump-a1-field\0clump-test-field\0clump-force-a1\0clump-test\0clump-snp-field\0clump-field\0clump\0", &help_ctrl, 0,
...
"  --clump-verbose      : Write a .clumps.verbose file with one row per clump\n"
"                         member: signed kb offset from the index variant, r^2\n"
"                         with it, the in-phase allele pair, source file, and\n"
"                         p-value.  The index variant is its own first row.\n"
"  --clump-best         : Write a .clumps.best file naming each clump's highest\n"
"                         r^2 member, in the same columns.\n"
"  --clump-annotate <field name(s)...> : Copy the named --clump input columns\n"
"                         into the --clump-verbose/--clump-best reports.\n"
