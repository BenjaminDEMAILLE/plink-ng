...
static PREFER_CONSTEXPR char ver_str[] = "PLINK v2.0.0-a.7.4"
#ifdef NOLAPACK
  "NL"
...
static const Plink1FlagHint kPlink1FlagHints[] = {
  ...
  {"hardy2", "use \"--hardy midp\" instead"},
  {"hethom", "use the --glm 'hethom' modifier instead"},
  {"hide-covar", "use the --glm 'hide-covar' modifier instead"},
  {"hwe-all", "no modifier needed; PLINK 1.x's --hwe considered controls only by default, while plink2's considers every sample passing the founder filter (see --nonfounders)"},
  {"hwe2", "use \"--hwe midp\" instead"},
